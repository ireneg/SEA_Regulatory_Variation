...
input_dir="/data/cephfs/punim0586/kbobowik/STAR/Hg38_SecondPass/Yamagishi/Sick"
...
output_dir="/data/cephfs/punim0586/kbobowik/Sumba/FeatureCounts/Yamagishi/sample_counts"
module load Subread
...
done > /data/cephfs/punim0586/kbobowik/Sumba/scripts/Array_Scripts/FeatureCounts_ArrayTable_YamagishiSick.txt
